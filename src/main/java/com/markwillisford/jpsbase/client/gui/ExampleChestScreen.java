package com.markwillisford.jpsbase.client.gui;
...
public class ExampleChestScreen extends ContainerScreen<ExampleChestContainer>{
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(JPsBase.MOD_ID, "textures/gui/example_chest.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		RenderSystem.color4f(1.0f, 1.0f, 1.0f, 1.0f); // this is a tinting (RGBA)
