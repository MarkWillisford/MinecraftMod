...
public class WillowFeature extends AbstractSmallTreeFeature<TreeFeatureConfig>{
	public WillowFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225798_1_) {
		super(p_i225798_1_);
	}
