package com.markwillisford.jpsbase.world.gen.feature;
...
public class modLakeFeature extends Feature<BlockStateFeatureConfig> {
	   ...
	   public modLakeFeature(Function<Dynamic<?>, ? extends BlockStateFeatureConfig> p_i51485_1_) {
	      super(p_i51485_1_);
	   }
	                     ...
	                     if (aboolean[(i2 * 16 + j3) * 8 + j4]) {
	                        ...
	                        if (isDirt(worldIn.getBlockState(blockpos).getBlock()) && worldIn.getLightFor(LightType.SKY, pos.add(i2, j4, j3)) > 0) {
	                           ...
	                           if (biome.getSurfaceBuilderConfig().getTop().getBlock() == Blocks.MYCELIUM) {
	                              ...
	                              worldIn.setBlockState(blockpos, BlockInitNew.ADAMANTINE_ORE.get().getDefaultState(), 2);					// Blocks.GRASS_BLOCK.getDefaultState(), 2);
	                           }
	                        }
	                     }
	                  }
	                  ...
	                  for(int k3 = 0; k3 < 16; ++k3) {
	                     for(int k4 = 0; k4 < 8; ++k4) {
	                        ...
	                        if (flag1 && (k4 < 4 || rand.nextInt(2) != 0) && worldIn.getBlockState(pos.add(j2, k4, k3)).getMaterial().isSolid()) {
	                           worldIn.setBlockState(pos.add(j2, k4, k3), BlockInitNew.ADAMANTINE_ORE.get().getDefaultState(), 2);	 //Blocks.STONE.getDefaultState(), 2);
	                        }
	                     }
	                  }
	               }
	               ...
	               for(int k2 = 0; k2 < 16; ++k2) {
	                  for(int l3 = 0; l3 < 16; ++l3) {
	                     ...
	                     if (worldIn.getBiome(blockpos1).doesWaterFreeze(worldIn, blockpos1, false)) {
	                        worldIn.setBlockState(blockpos1, BlockInitNew.ADAMANTINE_ORE.get().getDefaultState(), 2);	//Blocks.ICE.getDefaultState(), 2);
	                     }
	                  }
	               }
	            }
