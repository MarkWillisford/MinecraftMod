...
public class PineTree extends Tree{
	public static final TreeFeatureConfig PINE_TREE_CONFIG = (new TreeFeatureConfig.Builder(
			new SimpleBlockStateProvider(BlockInitNew.PINE_LOG.get().getDefaultState()), 
			new SimpleBlockStateProvider(BlockInitNew.PINE_LEAVES.get().getDefaultState()), 
			...
			.ignoreVines()
			.setSapling((net.minecraftforge.common.IPlantable)BlockInitNew.PINE_SAPLING.get()).build();
